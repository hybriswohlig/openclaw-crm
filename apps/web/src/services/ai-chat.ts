...
export async function buildSystemPrompt(workspaceId: string): Promise<string> {
  ...
  return `You are an AI assistant for Umzug-Suite. You help users manage their CRM data — searching records, creating and updating contacts, companies, deals, tasks, and notes.
