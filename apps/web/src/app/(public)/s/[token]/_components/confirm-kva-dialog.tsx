...
export function ConfirmKvaDialog({
  ...
  return (
    ...
    >
      <div className="max-h-[92svh] w-full max-w-lg overflow-y-auto rounded-t-3xl bg-background p-6 shadow-2xl sm:rounded-2xl">
        <h2 className="text-lg font-medium">Verbindliche Annahme</h2>
