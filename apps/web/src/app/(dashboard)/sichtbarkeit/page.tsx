...
const SITES = [
  { key: "", label: "Alle Websites" },
  { key: "kottke", label: "kottke-umzuege.de" },
  { key: "ruempeltuerken", label: "ruempeltuerken.de" },
];
...
export default function SichtbarkeitPage() {
  ...
  return (
    <div className="flex h-full flex-col overflow-auto" style={{ padding: "24px 28px", gap: 20 }}>
      <header className="flex flex-wrap items-baseline justify-between gap-3">
        <div>
          ...
          <p className="text-[13px]" style={{ color: "var(--ink-muted)" }}>
            Besuche, Quellen und Kontakte der Firmen-Websites · live aus PostHog
          </p>
        </div>
